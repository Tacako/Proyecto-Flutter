...
class SeguimientoGpsFerroPage extends StatefulWidget {
  @override
  _SeguimientoGpsFerroPageState createState() => _SeguimientoGpsFerroPageState();
}

class _SeguimientoGpsFerroPageState extends State<SeguimientoGpsFerroPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('Seguimiento GPS de Ferrocarril')),
      body: GoogleMap(
